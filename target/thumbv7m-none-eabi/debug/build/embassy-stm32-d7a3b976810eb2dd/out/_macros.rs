...
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((CAN,can,CAN,RX0,USB_LP_CAN1_RX0));
        __foreach_interrupt_inner!((CAN,can,CAN,RX1,CAN1_RX1));
        __foreach_interrupt_inner!((CAN,can,CAN,SCE,CAN1_SCE));
        __foreach_interrupt_inner!((CAN,can,CAN,TX,USB_HP_CAN1_TX));
        ...
        __foreach_interrupt_inner!((RTC,rtc,RTC,TAMP,TAMPER));
        ...
        __foreach_interrupt_inner!((USB,usb,USB,HP,USB_HP_CAN1_TX));
        __foreach_interrupt_inner!((USB,usb,USB,LP,USB_LP_CAN1_RX0));
        ...
        __foreach_interrupt_inner!((TAMPER));
        ...
        __foreach_interrupt_inner!((USB_HP_CAN1_TX));
        __foreach_interrupt_inner!((USB_LP_CAN1_RX0));
...
macro_rules! foreach_peripheral {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_peripheral_inner!((afio,AFIO));
        __foreach_peripheral_inner!((bkp,BKP));
